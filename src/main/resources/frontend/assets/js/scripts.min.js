        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.discountPrice ? '<span class="Card-priceOld">$' + book.price / 100 + '.' + book.price % 100 + '</span>\n' : '') + '                       <span class="Card-price">$' + book.discountPrice / 100 + '.' + book.discountPrice % 100 + '</span>\n' + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
