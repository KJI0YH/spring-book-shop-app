    ...
    $(function () {
        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    '<div class="Card-description"><span>' + book.authors + ' </span></div>' +
                    '<div class="Card-cost">' + (book.discountPrice ? '<span class="Card-priceOld">₽' + book.price + '</span>' : '') + '<span class="Card-price">₽' + book.discountPrice + '</span>' + '</div>' + '</div>' + '</div>';
            }
            return {
                init: function () {
            ...
            return {
                init: function () {
                    $('.btnBuy').on('click', function () {
                        Login().postData('/payment/cart', {}, function (result) {
        ...
        var Transactions = function () {
            var transactionTemplate = function (transaction) {
                ...
                var timeValue = String(date.getUTCDate()).padStart(2, '0') + '.' +
                    String(date.getUTCMonth() + 1).padStart(2, '0') + '.' +
                    date.getUTCFullYear() + ' ' +
                    String(date.getUTCHours()).padStart(2, '0') + ':' +
                    String(date.getUTCMinutes()).padStart(2, '0') + ':' +
                    String(date.getUTCSeconds()).padStart(2, '0');
                return '<tr><td>' + timeValue + '</td><td><span class="Transactions_textSuccess">' + '<strong>' + transaction.value + 'р.</strong></span></td><td>' + transaction.description + '</td></tr>';
            }
