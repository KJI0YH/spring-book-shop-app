...
public class ApiBookRateController {
    ...
    public ResponseEntity<ApiResponse> rateBook(@RequestBody BookRateDto bookRateDto) {
        if (bookRateDto == null || bookRateDto.getBookId() == null || bookRateDto.getValue() == null){
            return ResponseEntity
                    .badRequest()
                    .body(new ApiResponse(false, "Invalid book rate parameters"));
        }
        ...
        if (user == null) {
            return ResponseEntity
                    ...
                    .body(new ApiResponse(false, "To rate the book you need to log in"));
        }
    ...
    public ResponseEntity<ApiResponse> bookReview(@RequestBody BookReviewDto bookReviewDto){
        if (bookReviewDto == null || bookReviewDto.getBookId() == null || bookReviewDto.getText() == null){
            return ResponseEntity
                    ...
                    .body(new ApiResponse(false, "Invalid book review parameters"));
        }
        ...
        if (user == null){
            return ResponseEntity
                    .status(HttpStatus.FORBIDDEN)
                    .body(new ApiResponse( false, "To review the book you need to log in"));
        }
    ...
    public ResponseEntity<ApiResponse> rateBookReview(@RequestBody ReviewLikeDto reviewLikeDto){
        if (reviewLikeDto == null || reviewLikeDto.getReviewId() == null || reviewLikeDto.getValue() == null){
            return ResponseEntity
                    .badRequest()
                    .body(new ApiResponse(false, "Invalid review rate parameters"));
        }
        ...
        if (user == null){
            return ResponseEntity
                    .status(HttpStatus.FORBIDDEN)
                    .body(new ApiResponse(false, "To rate the review you need to log in"));
        }
