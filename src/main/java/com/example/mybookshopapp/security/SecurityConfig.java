...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .requestMatchers("/books/{bookSlug}/img/save").hasRole("ADMIN")
                .requestMatchers("/author/{authorSlug}/img/save").hasRole("ADMIN")
                .requestMatchers("/books/download/**").authenticated()
                .requestMatchers("/books/{bookSlug}/upload").hasRole("ADMIN")
